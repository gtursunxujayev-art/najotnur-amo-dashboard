              ...
              <table className="w-full text-left text-xs text-slate-200">
                <thead>
                  <tr className="border-b border-slate-700">
                    ...
                    <th className="px-3 py-2 text-center">% Q. lidga</th>
                    <th className="px-3 py-2 text-center">% Barcha lidga</th>
                    <th className="px-3 py-2 text-center">Qo'ng'iroqlar</th>
                    <th className="px-3 py-2 text-center">Vaqti (soat)</th>
                  </tr>
                </thead>
                <tbody>
                  {stats.managers.map((manager) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-2 text-center">{(manager.totalCallLength / 3600).toFixed(1)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  {[
                    ...
                    {
                      label: 'Malumot lidlar',
                      value: selectedManagerData.qualifiedLeads,
                    },
                    {
                      label: 'Noto\'g\'ri lidlar',
                ...
                <div className="rounded-lg bg-slate-800/50 p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-white">
                        {(selectedManagerData.dailyAvgCallLength / 60).toFixed(1)} min
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {selectedManagerData.lostLeadReasons.length > 0 && (
                  <div className="rounded-lg bg-slate-800/50 p-4">
                    <h3 className="mb-4 text-lg font-semibold text-white">Yo'qolib ketgan lidlar sabablari</h3>
